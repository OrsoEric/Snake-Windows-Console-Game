...
class Anima
{
	...
	public:
		...
		//Set the output buffer to a desired char
		bool set_output( char c );
		//Set a region to a given value
		//bool set_region( unsigned int r, unsigned int c, unsigned int rows, unsigned int cols, char data );
		//Print a string on screen safely
		//bool sprintf( unsigned int r, unsigned int c, ... );
